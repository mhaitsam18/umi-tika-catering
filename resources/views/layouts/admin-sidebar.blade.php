        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="/admin/member" class="nav-link">
                    ...
                    <span class="link-title">Data Member</span>
                </a>
            </li>
            <li class="nav-item nav-category">Catering Umi Tika</li>
            <li class="nav-item">
                <a href="/admin/paket" class="nav-link">
                    <i class="link-icon" data-feather="package"></i>
                    <span class="link-title">Data Paket</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/admin/jadwal-menu" class="nav-link">
                    <i class="link-icon" data-feather="calendar"></i>
                    <span class="link-title">Jadwal Menu</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="/admin/pemesanan-pembayaran" class="nav-link">
                    <i class="link-icon" data-feather="credit-card"></i>
                    <span class="link-title">Pemesanan dan Pembayaran</span>
                </a>
            </li>
        </ul>
    </div>
